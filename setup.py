...
'data/space-sim.png','data/up.png','data/down.png','data/water_slide.png','data/btnDecoration.png','data/btnAttractions.png','data/tree1.png','data/tree2.png',
'data/tree3.png','data/concert.png','data/arcadeImg.png','data/pathImg.png']
